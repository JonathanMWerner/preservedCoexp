...
Our measure of preserved co-expression quantifies the degree to which the top 10 co-expressed partners of a gene are shared between two co-expression networks. We use the auroc statistic, so for a single gene with an auroc of 1, the top 10 co-expressed partners for that gene across the two networks are exactly the same. 
...
knitr::include_graphics("man/figures/README-example_org_fetal_percentiles_violins.pdf")
#knitr::include_graphics("man/figures/README-example_org_org_percentiles_violins.pdf")
```
